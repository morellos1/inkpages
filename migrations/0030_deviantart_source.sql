-- Add the deviantart family to directory_entries.sources so the
-- directory's source facet can filter on it (discovered_via
-- 'deviantart_popular' -> 'deviantart'). View body otherwise identical
-- to migration 0028's (dumped via pg_get_viewdef).
