-- Add the artstation family to directory_entries.sources so the
-- directory's source facet can filter on it (discovered_via
-- 'artstation_ranking' -> 'artstation'). View body otherwise identical
-- to migration 0026's (dumped via pg_get_viewdef).
