-- Add display_name into the published accounts array so the UI can label
-- id-based platforms (pixiv, youtube) by their human name instead of the
-- numeric/opaque handle. Pure additive change to directory_entries.
